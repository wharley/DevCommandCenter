...
use workspace_commands::{
    ...
    workspace_local_branches, workspace_switch_local_branch,
    list_local_branches, list_mission_specs, list_repositories, list_workspace_bundles,
    list_workspaces, mission_spec_context_status, read_workspace_file, rename_workspace,
    resolve_workspace_source_url, restore_workspace, restore_workspace_bundle,
    save_mission_validation, search_workspace, set_repository_pinned, set_workspace_pinned,
    update_repository_identity, workspace_apply_delegation_worktree,
    ...
    workspace_git_accept_conflict, workspace_git_branch_diff, workspace_git_commit,
    workspace_git_commit_push, workspace_git_commit_suggestion, workspace_git_complete_merge,
...
pub fn run() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            create_workspace_from_source_url,
            ...
            list_local_branches,
            workspace_local_branches,
            workspace_switch_local_branch,
            ...
            workspace_change_request_context,
            ...
            workspace_apply_delegation_worktree,
            ...
            workspace_delivery_failure_snapshot,
            workspace_delivery_recovery_execute,
            workspace_git_push,
            ...
            workspace_pr_status,
            pull_request_hub_list,
            pull_request_hub_detail,
            pull_request_hub_comment,
            pull_request_hub_merge,
            pull_request_hub_submit_review,
            pull_request_hub_reply_thread,
            pull_request_hub_resolve_thread,
            workspace_review_state,
            ...
            provider_commands::connect_antigravity,
            ...
            session_commands::decision_provider_history,
            ...
            session_commands::get_session_objective,
